...
foreach($dataset as $item){
	if($item['address'] == $token){
		if($item['status'] == 'ENABLED'){
			$show = '<br><b><font color="green">Master Node is ONLINE !</font></b>';
		} else {
			$show = '<br><b><font color="red">Master Node is OFFLINE !</font></b>';
		}
	}
}
?>
...
<img style='display:block; width:10%;height:10%;' id='base64image'                 
